...
#                sys.exit()
            ...
            for w in d:
                if int(w) & 0x3ff == patt:
                    ...
                    #          	print hex(w)
            if debug:
                print hex(i_chan), hex(i_slip), hex(i_tap), hex(d[0] & 0x3ff ) , c
            ...
            board.dispatch()
        calc_swap = (i_slip+1)%2
        if swap == 0:
            swap = 1
            if debug:
                print "Writing to slip_h for chan, i_slip , swap = ", i_chan , i_slip , swap,calc_swap
            ...
            swap = 0
            if debug:
                print "Writing to slip_l for chan , i_slip , swap = ", i_chan , i_slip , swap,calc_swap
